...
public class TelcoServiceTest {
    ...
    // Isma
    @Test
    public void testRemoveCustomerWithCalls() throws InputValidationException, InstanceNotFoundException, CustomerHasCallsException {
